...
def fit():
    ...
    model_dict = {20: RIDGE(alpha=8, random_state=0), 40: RIDGE(alpha=3, random_state=0), 70:RIDGE(alpha=5, random_state=0),
                  80: RIDGE(alpha=0.51, random_state=0), 90: RIDGE(alpha=2, random_state=0)}
