...
def fit():
    ...
    model_dict = {20: SVC(kernel="rbf", C=0.31, gamma=0.91), 40: SVC(kernel="rbf", C=0.61, gamma=0.91),
                  70: SVC(kernel="rbf", C=0.61, gamma=0.61), 80: SVC(kernel="rbf", C=3, gamma=0.31),
                  90: SVC(kernel="rbf", C=0.01, gamma=0.31)}
